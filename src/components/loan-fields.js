...
class LoanFields extends React.Component {
    ...
    render() {
        ...
        }) : <div className="pa2">No activity performed</div>
                    ...
                    <div className="pa4 ph7-l georgia mw9-l center flex flex-row">
                        ...
                        <div className='flex w-70'>
                            <Paper className={this.props.classes.paperStyle} elevation={1}>
                                    ...
                                    >
                                        ...
                                        <div className="pa2 w-100">
                                            ...
                                            <Slider
                                                ...
                                                max={5000}
                                                classes={{ rail: this.props.classes.SliderTrack, track: this.props.classes.SliderTrack }}
                                            />
                                        </div>
                                        <div className="pa2">
                                ...
                                <div>
                                    <p><em>Final Calculated Result for monthly installment</em></p>
                                    <div className="flex flex-row">
                                        <div className="flex pa2 w-50">
